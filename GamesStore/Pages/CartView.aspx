<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CartView.aspx.cs" MasterPageFile="~/Pages/Store.Master" Inherits="GamesStore.Pages.CartView" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="bodyContent" runat="server">
    <div id="content">
        ...
        <table id="cartTable">
            ...
            <tbody>
                <asp:Repeater ItemType="GamesStore.Models.CartLine"
